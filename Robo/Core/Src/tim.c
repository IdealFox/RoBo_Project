...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = Encoder3_A_Pin|Encoder3_B_Pin|Encoder4_A_Pin|Encoder4_B_Pin;
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    */
    ...
    hdma_tim8_ch4_trig_com.Init.MemInc = DMA_MINC_DISABLE;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = Slave8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(Slave8_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Slave7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(Slave7_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = Slave6_Pin|Slave5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PE6     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = Slave2_Pin|Slave1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM10_MspPostInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = Slave4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(Slave4_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM11_MspPostInit 0 */
    ...
    PB9     ------> TIM11_CH1
    */
    GPIO_InitStruct.Pin = Slave3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM11;
    HAL_GPIO_Init(Slave3_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(GPIOD, Encoder3_A_Pin|Encoder3_B_Pin|Encoder4_A_Pin|Encoder4_B_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    HAL_GPIO_DeInit(GPIOC, Encoder1_A_Pin|Encoder1_B_Pin|Encoder2_A_Pin|Encoder2_B_Pin);
